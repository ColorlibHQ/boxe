...
$footer_bg_path = is_array($footer_bg_src) ? boxe_inline_bg_img($footer_bg_src[0]) : '';
?>
                                    ...
                                    <div class="social_icon">
                                        ...
                                        if (is_array($social_icons)) {
                                            for ($i = 0; $i < count($social_icons); $i++) {
                                                ...
                                                ?>
                                                <a href="<?php echo esc_url($social_icons[$i]['social_url']); ?>"><i
                                                            class="<?php echo esc_html(boxe_social_icon_overwrite_by_themefy_icon($social_icon)); ?>"></i></a>
                                                <?php
                                            }
                                        }
                                        ?>
