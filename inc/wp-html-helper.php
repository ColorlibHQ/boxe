...
// image default alt
if( !function_exists( 'boxe_img_default_alt' ) ){
	function boxe_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'boxe_img_tag' ) ){
	function boxe_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'boxe_anchor_tag' ) ){
	function boxe_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'boxe_heading_tag' ) ){
	function boxe_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'boxe_paragraph_tag' ) ){
	function boxe_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'boxe_other_tag' ) ){
	function boxe_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'boxe_button_element ' ) ){
	function boxe_button_element( array $args ){
