...
class Boxe_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Boxe ] Newsletter Form', 'boxe' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'boxe' ), )
        );
        ...
        <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="<?php echo esc_url( $actionurl ); ?>" method="post" class="form-inline">
                ...
                <div class="input-group mb-3">
                    <input class="form-control" name="EMAIL" placeholder="<?php esc_html_e( 'Your Email Address', 'boxe' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Email Address '" required="" type="email">
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'boxe' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'boxe'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'boxe'); ?> </p>
...
} // Class boxe_newsletter_widget ends here


// Register and load the widget
function boxe_newsletter_load_widget() {
	register_widget( 'Boxe_newsletter_widget' );
}
add_action( 'widgets_init', 'boxe_newsletter_load_widget' );