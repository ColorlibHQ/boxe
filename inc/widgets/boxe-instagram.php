...
----------------------------------------*/
class boxe_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('boxe_instagram_photo',esc_html__('[ Boxe ] Intagram Photo','boxe'),array(
			'description' => esc_html__('Boxe Instagram Photo Widget','boxe'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'boxe');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'boxe'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'boxe'); ?></label>
...
if(!function_exists('boxe_instagram_widgets')):
	function boxe_instagram_widgets(){
		register_widget('boxe_instagram_photo');
	}
	add_action('widgets_init','boxe_instagram_widgets');
endif;
