 ...
 */
	...
	class boxe_Enqueue{
		...
		public function boxe_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'boxe_frontend_enqueue_scripts', ) );
		}

		public function boxe_frontend_enqueue_scripts( ){
