...
gj.widget = function () {
    ...
    function (a) {
        ...
        fontawesome: {
            icons: {
                asc: '<i class="fa-solid fa-sort-amount-asc" aria-hidden="true"></i>',
                desc: '<i class="fa-solid fa-sort-amount-desc" aria-hidden="true"></i>'
            }
        },
        glyphicons: {
            icons: {
    ...
    function (a) {
        ...
        config: {
            ...
            fontawesome: {
                icons: {
                    expandRow: '<i class="fa-solid fa-angle-right" aria-hidden="true"></i>',
                    collapseRow: '<i class="fa-solid fa-angle-down" aria-hidden="true"></i>'
                }
            },
            glyphicons: {
                icons: {
        ...
        config: {
            ...
            fontawesome: {
                icons: {
                    first: '<i class="fa-solid fa-fast-backward" aria-hidden="true"></i>',
                    previous: '<i class="fa-solid fa-backward" aria-hidden="true"></i>',
                    next: '<i class="fa-solid fa-forward" aria-hidden="true"></i>',
                    last: '<i class="fa-solid fa-fast-forward" aria-hidden="true"></i>',
                    refresh: '<i class="fa-solid fa-refresh" aria-hidden="true"></i>'
                }
            }
        },
        private: {
        ...
        config: {
            ...
            fontawesome: {
                icons: {
                    expandGroup: '<i class="fa-solid fa-plus" aria-hidden="true"></i>',
                    collapseGroup: '<i class="fa-solid fa-minus" aria-hidden="true"></i>'
                }
            },
            glyphicons: {
                icons: {
        ...
        fontawesome: {
            ...
            icons: {
                expand: '<i class="fa-solid fa-plus" aria-hidden="true"></i>',
                collapse: '<i class="fa-solid fa-minus" aria-hidden="true"></i>'
            }
        },
        glyphicons: {
            style: {
    ...
    function (a) {
        ...
        fontawesome: {
            icons: {
                ...
                strikethrough: '<i class="fa-solid fa-strikethrough" aria-hidden="true"></i>',
                underline: '<i class="fa-solid fa-underline" aria-hidden="true"></i>',
                listBulleted: '<i class="fa-solid fa-list-ul" aria-hidden="true"></i>',
                listNumbered: '<i class="fa-solid fa-list-ol" aria-hidden="true"></i>',
                indentDecrease: '<i class="fa-solid fa-indent" aria-hidden="true"></i>',
                indentIncrease: '<i class="fa-solid fa-outdent" aria-hidden="true"></i>',
                alignLeft: '<i class="fa-solid fa-align-left" aria-hidden="true"></i>',
                alignCenter: '<i class="fa-solid fa-align-center" aria-hidden="true"></i>',
                alignRight: '<i class="fa-solid fa-align-right" aria-hidden="true"></i>',
                alignJustify: '<i class="fa-solid fa-align-justify" aria-hidden="true"></i>',
                undo: '<i class="fa-solid fa-undo" aria-hidden="true"></i>',
                redo: '<i class="fa-solid fa-repeat" aria-hidden="true"></i>'
            }
        }
    }, gj.editor.methods = {
        init: function (a) {
    ...
    function (a) {
        ...
        fontawesome: {
            icons: {
                dropdown: '<i class="fa-solid fa-caret-down" aria-hidden="true"></i>',
                dropup: '<i class="fa-solid fa-caret-up" aria-hidden="true"></i>'
            },
            style: {
    ...
    function (a) {
        ...
        fontawesome: {
            icons: {
                rightIcon: '<i class="fa-solid fa-calendar" aria-hidden="true"></i>',
                previousMonth: '<i class="fa-solid fa-chevron-left" aria-hidden="true"></i>',
                nextMonth: '<i class="fa-solid fa-chevron-right" aria-hidden="true"></i>'
            }
        },
        glyphicons: {
            icons: {
