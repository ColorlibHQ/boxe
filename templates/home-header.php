    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = boxe_opt( 'boxe_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo boxe_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( boxe_featured_post_cat() ){
                                echo '<span class="entry__category">'.boxe_featured_post_cat().'</span>';
                            }
                            ?>
